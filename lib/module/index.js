...
import { Button } from 'native-base'; // const LINKING_ERROR =
...
const NCButton = () => {
  return /*#__PURE__*/React.createElement(Button, null, /*#__PURE__*/React.createElement(Text, null, "Success"));
};

export { NCButton }; // const ComponentName = 'NcComponentsLeveloneView';
